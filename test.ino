...
// Support for "SimpleKeyColormapper" mode, which is mostly just the Numpad specific LED mode
...
KALEIDOSCOPE_INIT_PLUGINS(
  ...
  // The SimpelKeyColormapper plugin is responsible for lighting up the individual leds under the keys create with this Plugin

  SimpleKeyColormapper,
